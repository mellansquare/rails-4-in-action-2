...
ActiveRecord::Schema.define(version: 20_190_108_042_335) do
  ...
  add_index 'tags_tickets', %w[tag_id ticket_id], name: 'index_tags_tickets_on_tag_id_and_ticket_id'
  add_index 'tags_tickets', %w[ticket_id tag_id], name: 'index_tags_tickets_on_ticket_id_and_tag_id'
